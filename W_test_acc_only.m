function test_results=W_test_acc_only(W_graph, labled_num, splits_num, W_name, W_folder)
...
%         [W_graph.W]=zero_WOCW_labeled_W_by_ind(W_graph.W, labeled_ind, W_graph.labels);
        %% label propagation
